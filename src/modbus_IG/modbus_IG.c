...
// /* this part of the code is for modbus functionality*/
...
// // #define MODBUS_UART_LABEL DT_LABEL(DT_NODELABEL(uart1))
// // #define MODBUS_NODE DT_ALIAS(uart1)
...
void modbus_ig() {
//     // Initialization code
		LOG_INF("Hi from modbus function");
//    /* Here starts the modbus part of the code*/
